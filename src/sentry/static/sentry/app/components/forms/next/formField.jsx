...
class FormField extends React.Component {
  ...
  /**
   * Attempt to have model save field when enter is pressed
   * Model will determine if we should save (i.e. is `saveOnBlur` is enabled)
   */
  handleKeyDown = (...args) => {
    let {name, onKeyDown} = this.props;
